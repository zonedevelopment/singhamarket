...
class SummaryScreen extends React.Component {
                ...
                <View style={[styles.containerRow, { justifyContent: 'space-between', alignItems: 'center',paddingTop:5,paddingBottom:5 }]}>
                    ...
                    {/* <View style={[styles.containerRow]}>
                        <TouchableOpacity onPress={()=>{
                            ...
                            <Text style={[styles.text16, styles.bold,{color: primaryColor}]}>{`แก้ไข`}</Text>
                        </TouchableOpacity>
                        <View style={{ width: 1, backgroundColor: grayColor, margin: 4 }}></View>
                        <TouchableOpacity onPress={()=>{
                            this.CancelOrder(item.date)
                        }}>
                            <Text style={[styles.text16, styles.bold, { color: primaryColor }]}>{`ลบ`}</Text>
                        </TouchableOpacity>
                    </View> */}
                </View>
                {
    ...
    Reservation = () => {
       // this.props.setStateBookingSelected([])
        ...
        let formData = new FormData();
        formData.append('booking_type','ADMIN')
        formData.append('partners_id',this.props.reducer.audit_reserv_partners.partners_id)
                    ...
                    <ScrollView>
                        <View style={[styles.panelWhite, styles.shadow]}>
                            ...
                            <View style={[styles.mainButton, styles.center, { backgroundColor: redColor }]}>
                                ...
                                `โปรดชำระเงินก่อน ` + moment().add(this.props.reducer.audit_reserv_partners.partners_type == 1 ? this.props.reducer.CartPaymentTimeOut.Personal : this.props.reducer.CartPaymentTimeOut.Company, 'minutes').format('LT') + ` น.`}</Text>
                            </View>
                            <View style={[styles.marginBetweenVertical]}></View>
                            <View>
