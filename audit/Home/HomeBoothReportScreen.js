    ...
    _renderItem = ({ item, index }) => {
        return (
            <TouchableOpacity style={[styles.containerRow, { padding: 5,/* height: 50, */margin: -4 }]}
                ...
                <View style={[styles.containerRow, { flex: 0.55, backgroundColor: item.booking_status_background_color, alignItems: 'center', padding: 10 }]}>
                    <Text style={[styles.text16, { color: primaryColor, alignSelf: 'flex-start' }]}>{`${item.booth_name}: ${item.product_name}`}</Text>
                </View>
                <View style={[styles.containerRow, { flex: 0.20, backgroundColor: item.booking_status_background_color, justifyContent: 'center', alignItems: 'center', padding: 10 }]}>
                    <Icon name='check-square' size={22} color={item.check_in_status == 'Y' ? greenColor : grayColor} />
                    {
                        ...
                        <View>
                            ...
                            <View style={[styles.containerRow, { padding: 5, height: 55 }]}>
                                <View style={{ flex: 0.25, backgroundColor: primaryColor, justifyContent: 'center', alignItems: 'center', padding: 5 }}>
                                    <Text style={[styles.text16, { color: 'white' }]}>{`Zone`}</Text>
                                </View>
                                <View style={{ width: 1, backgroundColor: 'white' }}></View>
                                <View style={{ flex: 0.55, backgroundColor: primaryColor, justifyContent: 'center', padding: 5 }}>
                                    <Text style={[styles.text18, { color: 'white' }]}>{`รายละเอียด`}</Text>
                                </View>
                                <View style={{ width: 1, backgroundColor: 'white' }}></View>
                                <View style={{ flex: 0.20, backgroundColor: primaryColor, justifyContent: 'center', padding: 5 }}>
